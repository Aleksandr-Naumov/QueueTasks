namespace QueueTasks.Services
{
    ...
    internal class QueueOperatorManager : IQueueOperatorManager
    {
        private readonly ChannelService _channelService;
        private readonly QueueOperators _queue;
        ...
        public Channel<TaskFromChannel> AddToQueue(string operatorId)
        {
            ...
            else
            {
                ...
                // если потенциальную задачу уже назначали на другого оператора (оператор также остался первым в очереди)
        ...
        public async Task AddNotAssignedTask(string taskId)
        {
        ...
        public async Task AddAssignedTask(string taskId, string operatorId)
        {
